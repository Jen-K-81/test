...
#define _DIST_DEGREE 10.266 // (_DUTY_MAX - _DUTY_MIN) / 180 = 10.26666...

#define _DUTY_MIN 552 // servo full clockwise position (0 degree)
#define _DUTY_NEU 1476 // servo neutral position (90 degree)
#define _DUTY_MAX 2400 // servo full counterclockwise position (180 degree)

// global variables
float timeout; // unit: us
float dist_min, dist_max, dist_raw, dist_prev, dist_ema, dist_alpha, alpha, dist_degree; // unit: mm
...
// get a distance reading from the USS
  ...
  dist_ema = (alpha*dist_raw)+(1-alpha)*dist_raw;
...
if(dist_ema <= 180.0) {
     ...
     myservo.writeMicroseconds(_DUTY_MIN + 10*(dist_ema-180));
